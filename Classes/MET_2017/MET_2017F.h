...
// Tue Mar 24 19:58:21 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2017F.root
//////////////////////////////////////////////////////////
...
//   Float_t         Jet_btagDeepFlavC[50];   //[nJet]
//   Float_t         Jet_chEmEF[50];   //[nJet]
//   Float_t         Jet_chHEF[50];   //[nJet]
//   Float_t         Jet_eta[50];   //[nJet]
//   Float_t         Jet_jercCHF[50];   //[nJet]
//   Float_t         Jet_jercCHPUF[50];   //[nJet]
//   Float_t         Jet_mass[50];   //[nJet]
//   Float_t         Jet_muEF[50];   //[nJet]
//   Float_t         Jet_muonSubtrFactor[50];   //[nJet]
...
#ifdef MET_2017F_cxx
MET_2017F::MET_2017F(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2017F.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2017F.root");
      }
...
Int_t MET_2017F::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2017F::LoadTree(Long64_t entry)
{
...
void MET_2017F::Init(TTree *tree)
{
...
void MET_2017F::Show(Long64_t entry)
{
...
Int_t MET_2017F::Cut(Long64_t entry)
{
