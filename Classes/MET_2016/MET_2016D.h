...
// Tue Mar 24 21:04:17 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2016D.root
//////////////////////////////////////////////////////////
...
//   Float_t         Jet_jercCHF[33];   //[nJet]
//   Float_t         Jet_jercCHPUF[33];   //[nJet]
...
//   UInt_t          nPhoton;
//   Float_t         Photon_eCorr[59];   //[nPhoton]
//   Float_t         Photon_energyErr[59];   //[nPhoton]
//   Float_t         Photon_eta[59];   //[nPhoton]
//   Float_t         Photon_hoe[59];   //[nPhoton]
//   Float_t         Photon_mass[59];   //[nPhoton]
//   Float_t         Photon_mvaID[59];   //[nPhoton]
//   Float_t         Photon_mvaID17[59];   //[nPhoton]
//   Float_t         Photon_pfRelIso03_all[59];   //[nPhoton]
//   Float_t         Photon_pfRelIso03_chg[59];   //[nPhoton]
//   Float_t         Photon_phi[59];   //[nPhoton]
//   Float_t         Photon_pt[59];   //[nPhoton]
//   Float_t         Photon_r9[59];   //[nPhoton]
//   Float_t         Photon_sieie[59];   //[nPhoton]
//   Int_t           Photon_charge[59];   //[nPhoton]
//   Int_t           Photon_cutBased[59];   //[nPhoton]
//   Int_t           Photon_cutBased17Bitmap[59];   //[nPhoton]
//   Int_t           Photon_electronIdx[59];   //[nPhoton]
//   Int_t           Photon_jetIdx[59];   //[nPhoton]
//   Int_t           Photon_pdgId[59];   //[nPhoton]
//   Int_t           Photon_vidNestedWPBitmap[59];   //[nPhoton]
//   Bool_t          Photon_electronVeto[59];   //[nPhoton]
//   Bool_t          Photon_isScEtaEB[59];   //[nPhoton]
//   Bool_t          Photon_isScEtaEE[59];   //[nPhoton]
//   Bool_t          Photon_mvaID17_WP80[59];   //[nPhoton]
//   Bool_t          Photon_mvaID17_WP90[59];   //[nPhoton]
//   Bool_t          Photon_mvaID_WP80[59];   //[nPhoton]
//   Bool_t          Photon_mvaID_WP90[59];   //[nPhoton]
//   Bool_t          Photon_pixelSeed[59];   //[nPhoton]
//   UChar_t         Photon_seedGain[59];   //[nPhoton]
...
//   Float_t         TkMET_sumEt;
//   UInt_t          nTrigObj;
//   Float_t         TrigObj_pt[62];   //[nTrigObj]
//   Float_t         TrigObj_eta[62];   //[nTrigObj]
//   Float_t         TrigObj_phi[62];   //[nTrigObj]
//   Float_t         TrigObj_l1pt[62];   //[nTrigObj]
//   Float_t         TrigObj_l1pt_2[62];   //[nTrigObj]
//   Float_t         TrigObj_l2pt[62];   //[nTrigObj]
//   Int_t           TrigObj_id[62];   //[nTrigObj]
//   Int_t           TrigObj_l1iso[62];   //[nTrigObj]
//   Int_t           TrigObj_l1charge[62];   //[nTrigObj]
//   Int_t           TrigObj_filterBits[62];   //[nTrigObj]
//   UInt_t          nOtherPV;
...
//   UChar_t         Photon_cleanmask[59];   //[nPhoton]
...
#ifdef MET_2016D_cxx
MET_2016D::MET_2016D(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2016D.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2016D.root");
      }
...
Int_t MET_2016D::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2016D::LoadTree(Long64_t entry)
{
...
void MET_2016D::Init(TTree *tree)
{
...
void MET_2016D::Show(Long64_t entry)
{
...
Int_t MET_2016D::Cut(Long64_t entry)
{
