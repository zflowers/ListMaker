...
// Fri Mar 20 14:28:27 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2016C.root
//////////////////////////////////////////////////////////
...
//   Int_t           Jet_nConstituents[46];   //[nJet]
...
#ifdef MET_2016C_cxx
MET_2016C::MET_2016(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2016C.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2016C.root");
      }
...
Int_t MET_2016C::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2016C::LoadTree(Long64_t entry)
{
...
void MET_2016C::Init(TTree *tree)
{
...
void MET_2016C::Show(Long64_t entry)
{
...
Int_t MET_2016C::Cut(Long64_t entry)
{
