...
// Fri Mar 20 17:10:43 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2016H.root
//////////////////////////////////////////////////////////
...
//   Float_t         Photon_mvaID17[14];   //[nPhoton]
...
//   Int_t           Photon_cutBased17Bitmap[14];   //[nPhoton]
...
//   Bool_t          Photon_mvaID17_WP80[14];   //[nPhoton]
//   Bool_t          Photon_mvaID17_WP90[14];   //[nPhoton]
...
#ifdef MET_2016H_cxx
MET_2016H::MET_2016H(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2016H.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2016H.root");
      }
...
Int_t MET_2016H::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2016H::LoadTree(Long64_t entry)
{
...
void MET_2016H::Init(TTree *tree)
{
...
void MET_2016H::Show(Long64_t entry)
{
...
Int_t MET_2016H::Cut(Long64_t entry)
{
