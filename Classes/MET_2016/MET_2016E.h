...
// Mon Mar 23 17:17:46 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2016E.root
//////////////////////////////////////////////////////////
...
//   UInt_t          nPhoton;
//   Float_t         Photon_eCorr[124];   //[nPhoton]
//   Float_t         Photon_energyErr[124];   //[nPhoton]
//   Float_t         Photon_eta[124];   //[nPhoton]
//   Float_t         Photon_hoe[124];   //[nPhoton]
//   Float_t         Photon_mass[124];   //[nPhoton]
//   Float_t         Photon_mvaID[124];   //[nPhoton]
//   Float_t         Photon_mvaID17[124];   //[nPhoton]
//   Float_t         Photon_pfRelIso03_all[124];   //[nPhoton]
//   Float_t         Photon_pfRelIso03_chg[124];   //[nPhoton]
//   Float_t         Photon_phi[124];   //[nPhoton]
//   Float_t         Photon_pt[124];   //[nPhoton]
//   Float_t         Photon_r9[124];   //[nPhoton]
//   Float_t         Photon_sieie[124];   //[nPhoton]
//   Int_t           Photon_charge[124];   //[nPhoton]
//   Int_t           Photon_cutBased[124];   //[nPhoton]
//   Int_t           Photon_cutBased17Bitmap[124];   //[nPhoton]
//   Int_t           Photon_electronIdx[124];   //[nPhoton]
//   Int_t           Photon_jetIdx[124];   //[nPhoton]
//   Int_t           Photon_pdgId[124];   //[nPhoton]
//   Int_t           Photon_vidNestedWPBitmap[124];   //[nPhoton]
//   Bool_t          Photon_electronVeto[124];   //[nPhoton]
//   Bool_t          Photon_isScEtaEB[124];   //[nPhoton]
//   Bool_t          Photon_isScEtaEE[124];   //[nPhoton]
//   Bool_t          Photon_mvaID17_WP80[124];   //[nPhoton]
//   Bool_t          Photon_mvaID17_WP90[124];   //[nPhoton]
//   Bool_t          Photon_mvaID_WP80[124];   //[nPhoton]
//   Bool_t          Photon_mvaID_WP90[124];   //[nPhoton]
//   Bool_t          Photon_pixelSeed[124];   //[nPhoton]
//   UChar_t         Photon_seedGain[124];   //[nPhoton]
...
//   Float_t         TkMET_sumEt;
//   UInt_t          nTrigObj;
//   Float_t         TrigObj_pt[104];   //[nTrigObj]
//   Float_t         TrigObj_eta[104];   //[nTrigObj]
//   Float_t         TrigObj_phi[104];   //[nTrigObj]
//   Float_t         TrigObj_l1pt[104];   //[nTrigObj]
//   Float_t         TrigObj_l1pt_2[104];   //[nTrigObj]
//   Float_t         TrigObj_l2pt[104];   //[nTrigObj]
//   Int_t           TrigObj_id[104];   //[nTrigObj]
//   Int_t           TrigObj_l1iso[104];   //[nTrigObj]
//   Int_t           TrigObj_l1charge[104];   //[nTrigObj]
//   Int_t           TrigObj_filterBits[104];   //[nTrigObj]
//   UInt_t          nOtherPV;
...
//   UChar_t         Photon_cleanmask[124];   //[nPhoton]
...
#ifdef MET_2016E_cxx
MET_2016E::MET_2016E(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2016E.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2016E.root");
      }
...
Int_t MET_2016E::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2016E::LoadTree(Long64_t entry)
{
...
void MET_2016E::Init(TTree *tree)
{
...
void MET_2016E::Show(Long64_t entry)
{
...
Int_t MET_2016E::Cut(Long64_t entry)
{
