...
// Wed Mar 25 09:52:42 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2018C.root
//////////////////////////////////////////////////////////
...
//   Float_t         TkMET_sumEt;
//   UInt_t          nTrigObj;
//   Float_t         TrigObj_pt[25];   //[nTrigObj]
//   Float_t         TrigObj_eta[25];   //[nTrigObj]
//   Float_t         TrigObj_phi[25];   //[nTrigObj]
//   Float_t         TrigObj_l1pt[25];   //[nTrigObj]
//   Float_t         TrigObj_l1pt_2[25];   //[nTrigObj]
//   Float_t         TrigObj_l2pt[25];   //[nTrigObj]
//   Int_t           TrigObj_id[25];   //[nTrigObj]
//   Int_t           TrigObj_l1iso[25];   //[nTrigObj]
//   Int_t           TrigObj_l1charge[25];   //[nTrigObj]
//   Int_t           TrigObj_filterBits[25];   //[nTrigObj]
//   UInt_t          nOtherPV;
...
#ifdef MET_2018C_cxx
MET_2018C::MET_2018C(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2018C.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2018C.root");
      }
...
Int_t MET_2018C::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2018C::LoadTree(Long64_t entry)
{
...
void MET_2018C::Init(TTree *tree)
{
...
void MET_2018C::Show(Long64_t entry)
{
...
Int_t MET_2018C::Cut(Long64_t entry)
{
