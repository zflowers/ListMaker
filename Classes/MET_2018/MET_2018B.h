...
// Wed Mar 25 09:15:43 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2018B.root
//////////////////////////////////////////////////////////
...
//   Float_t         CorrT1METJet_area[44];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_eta[44];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_muonSubtrFactor[44];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_phi[44];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_rawPt[44];   //[nCorrT1METJet]
//   UInt_t          nElectron;
//   Float_t         Electron_deltaEtaSC[16];   //[nElectron]
//   Float_t         Electron_dr03EcalRecHitSumEt[16];   //[nElectron]
//   Float_t         Electron_dr03HcalDepth1TowerSumEt[16];   //[nElectron]
//   Float_t         Electron_dr03TkSumPt[16];   //[nElectron]
//   Float_t         Electron_dr03TkSumPtHEEP[16];   //[nElectron]
//   Float_t         Electron_dxy[16];   //[nElectron]
//   Float_t         Electron_dxyErr[16];   //[nElectron]
//   Float_t         Electron_dz[16];   //[nElectron]
//   Float_t         Electron_dzErr[16];   //[nElectron]
//   Float_t         Electron_eCorr[16];   //[nElectron]
//   Float_t         Electron_eInvMinusPInv[16];   //[nElectron]
//   Float_t         Electron_energyErr[16];   //[nElectron]
//   Float_t         Electron_eta[16];   //[nElectron]
//   Float_t         Electron_hoe[16];   //[nElectron]
//   Float_t         Electron_ip3d[16];   //[nElectron]
//   Float_t         Electron_jetPtRelv2[16];   //[nElectron]
//   Float_t         Electron_jetRelIso[16];   //[nElectron]
//   Float_t         Electron_mass[16];   //[nElectron]
//   Float_t         Electron_miniPFRelIso_all[16];   //[nElectron]
//   Float_t         Electron_miniPFRelIso_chg[16];   //[nElectron]
//   Float_t         Electron_mvaFall17V1Iso[16];   //[nElectron]
//   Float_t         Electron_mvaFall17V1noIso[16];   //[nElectron]
//   Float_t         Electron_mvaFall17V2Iso[16];   //[nElectron]
//   Float_t         Electron_mvaFall17V2noIso[16];   //[nElectron]
//   Float_t         Electron_pfRelIso03_all[16];   //[nElectron]
//   Float_t         Electron_pfRelIso03_chg[16];   //[nElectron]
//   Float_t         Electron_phi[16];   //[nElectron]
//   Float_t         Electron_pt[16];   //[nElectron]
//   Float_t         Electron_r9[16];   //[nElectron]
//   Float_t         Electron_sieie[16];   //[nElectron]
//   Float_t         Electron_sip3d[16];   //[nElectron]
//   Float_t         Electron_mvaTTH[16];   //[nElectron]
//   Int_t           Electron_charge[16];   //[nElectron]
//   Int_t           Electron_cutBased[16];   //[nElectron]
//   Int_t           Electron_cutBased_Fall17_V1[16];   //[nElectron]
//   Int_t           Electron_jetIdx[16];   //[nElectron]
//   Int_t           Electron_pdgId[16];   //[nElectron]
//   Int_t           Electron_photonIdx[16];   //[nElectron]
//   Int_t           Electron_tightCharge[16];   //[nElectron]
//   Int_t           Electron_vidNestedWPBitmap[16];   //[nElectron]
//   Int_t           Electron_vidNestedWPBitmapHEEP[16];   //[nElectron]
//   Bool_t          Electron_convVeto[16];   //[nElectron]
//   Bool_t          Electron_cutBased_HEEP[16];   //[nElectron]
//   Bool_t          Electron_isPFcand[16];   //[nElectron]
//   UChar_t         Electron_lostHits[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V1Iso_WP80[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V1Iso_WP90[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V1Iso_WPL[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V1noIso_WP80[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V1noIso_WP90[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V1noIso_WPL[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V2Iso_WP80[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V2Iso_WP90[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V2Iso_WPL[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V2noIso_WP80[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V2noIso_WP90[16];   //[nElectron]
//   Bool_t          Electron_mvaFall17V2noIso_WPL[16];   //[nElectron]
//   UChar_t         Electron_seedGain[16];   //[nElectron]
...
//   UInt_t          nPhoton;
//   Float_t         Photon_eCorr[17];   //[nPhoton]
//   Float_t         Photon_energyErr[17];   //[nPhoton]
//   Float_t         Photon_eta[17];   //[nPhoton]
//   Float_t         Photon_hoe[17];   //[nPhoton]
//   Float_t         Photon_mass[17];   //[nPhoton]
//   Float_t         Photon_mvaID[17];   //[nPhoton]
//   Float_t         Photon_mvaIDV1[17];   //[nPhoton]
//   Float_t         Photon_pfRelIso03_all[17];   //[nPhoton]
//   Float_t         Photon_pfRelIso03_chg[17];   //[nPhoton]
//   Float_t         Photon_phi[17];   //[nPhoton]
//   Float_t         Photon_pt[17];   //[nPhoton]
//   Float_t         Photon_r9[17];   //[nPhoton]
//   Float_t         Photon_sieie[17];   //[nPhoton]
//   Int_t           Photon_charge[17];   //[nPhoton]
//   Int_t           Photon_cutBasedBitmap[17];   //[nPhoton]
//   Int_t           Photon_cutBasedV1Bitmap[17];   //[nPhoton]
//   Int_t           Photon_electronIdx[17];   //[nPhoton]
//   Int_t           Photon_jetIdx[17];   //[nPhoton]
//   Int_t           Photon_pdgId[17];   //[nPhoton]
//   Int_t           Photon_vidNestedWPBitmap[17];   //[nPhoton]
//   Bool_t          Photon_electronVeto[17];   //[nPhoton]
//   Bool_t          Photon_isScEtaEB[17];   //[nPhoton]
//   Bool_t          Photon_isScEtaEE[17];   //[nPhoton]
//   Bool_t          Photon_mvaID_WP80[17];   //[nPhoton]
//   Bool_t          Photon_mvaID_WP90[17];   //[nPhoton]
//   Bool_t          Photon_pixelSeed[17];   //[nPhoton]
//   UChar_t         Photon_seedGain[17];   //[nPhoton]
...
//   UChar_t         Electron_cleanmask[16];   //[nElectron]
//   UChar_t         Jet_cleanmask[48];   //[nJet]
//   UChar_t         Muon_cleanmask[9];   //[nMuon]
//   UChar_t         Photon_cleanmask[17];   //[nPhoton]
...
#ifdef MET_2018B_cxx
MET_2018B::MET_2018B(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2018B.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2018B.root");
      }
...
Int_t MET_2018B::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2018B::LoadTree(Long64_t entry)
{
...
void MET_2018B::Init(TTree *tree)
{
...
void MET_2018B::Show(Long64_t entry)
{
...
Int_t MET_2018B::Cut(Long64_t entry)
{
