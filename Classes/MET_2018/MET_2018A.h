...
// Wed Mar 25 08:54:59 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: MET_2018A.root
//////////////////////////////////////////////////////////
...
//   Float_t         CorrT1METJet_area[42];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_eta[42];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_muonSubtrFactor[42];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_phi[42];   //[nCorrT1METJet]
//   Float_t         CorrT1METJet_rawPt[42];   //[nCorrT1METJet]
//   UInt_t          nElectron;
...
//   UInt_t          nJet;
//   Float_t         Jet_area[52];   //[nJet]
//   Float_t         Jet_btagCMVA[52];   //[nJet]
//   Float_t         Jet_btagCSVV2[52];   //[nJet]
//   Float_t         Jet_btagDeepB[52];   //[nJet]
//   Float_t         Jet_btagDeepC[52];   //[nJet]
//   Float_t         Jet_btagDeepFlavB[52];   //[nJet]
//   Float_t         Jet_btagDeepFlavC[52];   //[nJet]
//   Float_t         Jet_chEmEF[52];   //[nJet]
//   Float_t         Jet_chHEF[52];   //[nJet]
//   Float_t         Jet_eta[52];   //[nJet]
//   Float_t         Jet_jercCHF[52];   //[nJet]
//   Float_t         Jet_jercCHPUF[52];   //[nJet]
//   Float_t         Jet_mass[52];   //[nJet]
//   Float_t         Jet_muEF[52];   //[nJet]
//   Float_t         Jet_muonSubtrFactor[52];   //[nJet]
//   Float_t         Jet_neEmEF[52];   //[nJet]
//   Float_t         Jet_neHEF[52];   //[nJet]
//   Float_t         Jet_phi[52];   //[nJet]
//   Float_t         Jet_pt[52];   //[nJet]
//   Float_t         Jet_qgl[52];   //[nJet]
//   Float_t         Jet_rawFactor[52];   //[nJet]
//   Float_t         Jet_bRegCorr[52];   //[nJet]
//   Float_t         Jet_bRegRes[52];   //[nJet]
//   Int_t           Jet_electronIdx1[52];   //[nJet]
//   Int_t           Jet_electronIdx2[52];   //[nJet]
//   Int_t           Jet_jetId[52];   //[nJet]
//   Int_t           Jet_muonIdx1[52];   //[nJet]
//   Int_t           Jet_muonIdx2[52];   //[nJet]
//   Int_t           Jet_nConstituents[52];   //[nJet]
//   Int_t           Jet_nElectrons[52];   //[nJet]
//   Int_t           Jet_nMuons[52];   //[nJet]
//   Int_t           Jet_puId[52];   //[nJet]
...
#ifdef MET_2018A_cxx
MET_2018A::MET_2018A(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MET_2018A.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MET_2018A.root");
      }
...
Int_t MET_2018A::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MET_2018A::LoadTree(Long64_t entry)
{
...
void MET_2018A::Init(TTree *tree)
{
...
void MET_2018A::Show(Long64_t entry)
{
...
Int_t MET_2018A::Cut(Long64_t entry)
{
